---
title: "Dappnode content provider"
llm_description: "Optional HTTP content provider operated by Dappnode as a fast alternative to IPFS for downloading large packages from the Dappstore."
---
