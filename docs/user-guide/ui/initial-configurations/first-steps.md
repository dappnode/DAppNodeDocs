...
This configuration can be modified whatever you want. You can find all the information with all the details about this decision in [this section](https://docs.dappnode.io/first-steps).
