...
You can find a more detailed information on the section [select a type of client](first-steps/select-a-client.md). It's important to understand the pros and cons of this decision.
...
As we said before if you want to know the pros and cons of this decisions, we recommend you to read [select a type of client](first-steps/select-a-client.md) section.
